      ...
      >
        {resultadosR1 && (
          <View style={{
            ...
            <Text style={{ marginTop: 6, color: '#aaa', fontStyle: 'italic', textAlign: 'left', fontSize: 11 }}>
              Promedio: <Text style={{ color: '#ff66c4' }}>{parseFloat(resultadosR1.promedio).toFixed(4)}</Text> | −5%: <Text style={{ color: '#ff66c4' }}>{parseFloat(resultadosR1.promedioMinus5).toFixed(4)}</Text>
            </Text>
          </View>
        )}
        ...
        {rondas.map((ronda, idx) => (
          <View key={idx} style={{
            ...
            <Text style={{ marginTop: 6, color: '#aaa', fontStyle: 'italic', textAlign: 'left', fontSize: 11 }}>
              Promedio: <Text style={{ color: '#ff66c4' }}>{parseFloat(ronda.promedio).toFixed(4)}</Text> | −5%: <Text style={{ color: '#ff66c4' }}>{parseFloat(ronda.promedioMenos5).toFixed(4)}</Text>
            </Text>
          </View>
        ))}
      </ScrollView>
